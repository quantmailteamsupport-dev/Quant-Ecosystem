...
// Mobile accessibility features for social media platform
...
export class AccessibilityService {
  ...
  private registerDefaultVoiceCommands(): void {
    const commands: VoiceCommand[] = [
      { id: 'cmd_create_post', phrase: 'create_post', aliases: ['do create_post'], action: 'create_post', enabled: true },
      { id: 'cmd_view_feed', phrase: 'view_feed', aliases: ['do view_feed'], action: 'view_feed', enabled: true },
      { id: 'cmd_view_notifications', phrase: 'view_notifications', aliases: ['do view_notifications'], action: 'view_notifications', enabled: true },
