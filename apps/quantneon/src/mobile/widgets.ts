// Quantneon - Widget Service
// Mobile home screen widgets for social media platform
...
export class WidgetService {
  ...
  private registerDefaultWidgets(): void {
    const defaults: WidgetDefinition[] = [
      { id: 'notifications_feed', name: 'Notifications_feed', description: 'Shows recent notifications', sizes: ['small', 'medium'], refreshInterval: '15min', configurable: true, previewImageUrl: '/widgets/notifications_feed_preview.png' },
      { id: 'post_performance', name: 'Post_performance', description: 'Shows latest post engagement', sizes: ['medium', 'large'], refreshInterval: '30min', configurable: true, previewImageUrl: '/widgets/post_performance_preview.png' },
