  ...
  const creators = [
    {
      ...
      avatarUrl: 'https://picsum.photos/seed/rc1/80/80',
      isVerified: true,
    ...
    },
    {
      ...
      avatarUrl: 'https://picsum.photos/seed/rc2/80/80',
      isVerified: true,
      followerCount: 5800000,
    },
    {
      id: 'c3',
      username: 'travel_clips',
      avatarUrl: 'https://picsum.photos/seed/rc3/80/80',
      isVerified: false,
    ...
    },
    {
      id: 'c4',
      username: 'food_magic',
      avatarUrl: 'https://picsum.photos/seed/rc4/80/80',
      isVerified: false,
    ...
    },
    {
      ...
      avatarUrl: 'https://picsum.photos/seed/rc5/80/80',
      isVerified: true,
      followerCount: 3400000,
    },
    {
      id: 'c6',
      username: 'art_timelapse',
      avatarUrl: 'https://picsum.photos/seed/rc6/80/80',
      isVerified: false,
    ...
    },
    {
      id: 'c7',
      username: 'pet_daily',
      avatarUrl: 'https://picsum.photos/seed/rc7/80/80',
      isVerified: false,
      followerCount: 950000,
    },
    {
      id: 'c8',
      username: 'music_covers',
      avatarUrl: 'https://picsum.photos/seed/rc8/80/80',
      isVerified: true,
...
const generateComments = (): ReelComment[] => [
  {
    id: 'rc1',
    username: 'viewer_one',
    avatarUrl: 'https://picsum.photos/seed/rv1/40/40',
  ...
  },
  {
    ...
    avatarUrl: 'https://picsum.photos/seed/rv2/40/40',
  ...
  },
  {
    ...
    avatarUrl: 'https://picsum.photos/seed/rv3/40/40',
    text: 'Been watching this on repeat',
    likes: 67,
    timestamp: '45m',
  },
  {
    ...
    avatarUrl: 'https://picsum.photos/seed/rv4/40/40',
    text: 'Just followed! Amazing content',
    likes: 23,
    timestamp: '30m',
  },
];
...
const ReelsPage: React.FC = () => {
  ...
  return (
    <div className="relative h-screen bg-black overflow-hidden select-none">
      ...
      {/* Full-screen reel */}
      <div className="relative w-full h-full" onDoubleClick={() => handleDoubleTap(currentReel.id)}>
        ...
        <div className="absolute right-3 bottom-24 flex flex-col items-center gap-5 z-10">
          ...
          <div className="relative">
            <div className="w-10 h-10 rounded-full border-2 border-white overflow-hidden">
              <img
                ...
                alt={currentReel.creator.username}
                className="w-full h-full object-cover"
              />
            </div>
            {!isFollowing && (
          ...
          >
            ...
            <span className="text-white text-xs font-medium">
              {formatCount(currentReel.likeCount + (isLiked ? 1 : 0))}
            </span>
          </button>
          ...
          <button className="flex flex-col items-center gap-1">
            ...
            <span className="text-white text-xs font-medium">
              {formatCount(currentReel.shareCount)}
            </span>
          </button>
          ...
          >
            ...
            <span className="text-white text-xs font-medium">
              {formatCount(currentReel.saveCount)}
            </span>
          </button>
          ...
          <button onClick={handleToggleMute} className="flex flex-col items-center gap-1">
            <div
              className="w-7 h-7 rounded-md border border-white overflow-hidden animate-spin"
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="overflow-hidden">
              <p className="text-white text-xs whitespace-nowrap animate-marquee">
                {currentReel.soundName} - {currentReel.soundArtist}{' '}
                {currentReel.isOriginalSound && '(Original Sound)'}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="absolute inset-0 z-50 flex flex-col">
          ...
          <div className="bg-gray-900 rounded-t-2xl max-h-[60vh] flex flex-col">
            ...
            <div className="flex items-center gap-3 px-4 py-3 border-t border-gray-800">
              ...
              />
              {commentText.trim() && (
                <button onClick={handlePostComment} className="text-blue-500 font-semibold text-sm">
                  Post
                </button>
              )}
            </div>
