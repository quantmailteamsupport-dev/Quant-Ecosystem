// Quantmail - Deep Linking Service
// Mobile deep link handling for email platform
...
export class DeepLinkService {
  ...
  private universalLinkConfig: UniversalLinkConfig = {
    domain: 'quantmail.quant.app',
    appId: 'com.quant.quantmail',
    paths: ['/mail/*', '/thread/*', '/compose/*', '/folders/*'],
  ...
  private registerDefaultRoutes(): void {
    const defaultRoutes: DeepLinkRoute[] = [
      { pattern: '/mail/:id', screen: 'mailDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: true, fallbackUrl: 'https://quantmail.quant.app/mail' },
      { pattern: '/thread/:id', screen: 'threadDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: true, fallbackUrl: 'https://quantmail.quant.app/thread' },
      { pattern: '/compose/:id', screen: 'composeDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: false, fallbackUrl: 'https://quantmail.quant.app/compose' },
      { pattern: '/folders/:id', screen: 'foldersDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: true, fallbackUrl: 'https://quantmail.quant.app/folders' },
      { pattern: '/settings/:section', screen: 'settings', params: [{ name: 'section', type: 'string', required: false, defaultValue: 'general' }], requiresAuth: true, fallbackUrl: 'https://quantmail.quant.app/settings' },
      { pattern: '/invite/:code', screen: 'invite', params: [{ name: 'code', type: 'string', required: true }], requiresAuth: false, fallbackUrl: 'https://quantmail.quant.app/invite' },
      { pattern: '/share/:contentType/:id', screen: 'sharedContent', params: [{ name: 'contentType', type: 'string', required: true }, { name: 'id', type: 'string', required: true }], requiresAuth: false, fallbackUrl: 'https://quantmail.quant.app/share' },
    ];
