// Quantmail - Haptics Service
// Mobile haptic feedback for email platform
...
export class HapticsService {
  ...
  private registerDefaultTriggers(): void {
    const triggers: HapticTriggerConfig[] = [
      { action: 'email_sent', pattern: 'medium', enabled: true },
      { action: 'email_archived', pattern: 'success', enabled: true },
      { action: 'swipe_action', pattern: 'light', enabled: true },
