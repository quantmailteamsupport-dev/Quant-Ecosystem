// Quantmail - Accessibility Service
// Mobile accessibility features for email platform
...
export class AccessibilityService {
  ...
  private registerDefaultVoiceCommands(): void {
    const commands: VoiceCommand[] = [
      { id: 'cmd_compose_email', phrase: 'compose_email', aliases: ['do compose_email'], action: 'compose_email', enabled: true },
      { id: 'cmd_check_inbox', phrase: 'check_inbox', aliases: ['do check_inbox'], action: 'check_inbox', enabled: true },
      { id: 'cmd_read_latest', phrase: 'read_latest', aliases: ['do read_latest'], action: 'read_latest', enabled: true },
