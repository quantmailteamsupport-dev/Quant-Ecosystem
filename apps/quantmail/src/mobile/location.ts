// Quantmail - Location Service
// Mobile location services for email platform
...
export class LocationService {
  ...
  private backgroundConfig: BackgroundLocationConfig = {
    ...
    notificationTitle: 'Quantmail Location',
    notificationBody: 'Using location for location signatures',
  };
