// Quantube - Deep Linking Service
// Mobile deep link handling for video platform
...
export class DeepLinkService {
  ...
  private universalLinkConfig: UniversalLinkConfig = {
    domain: 'quantube.quant.app',
    appId: 'com.quant.quantube',
    paths: ['/video/*', '/channel/*', '/playlist/*', '/studio/*'],
  ...
  private registerDefaultRoutes(): void {
    const defaultRoutes: DeepLinkRoute[] = [
      { pattern: '/video/:id', screen: 'videoDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: true, fallbackUrl: 'https://quantube.quant.app/video' },
      { pattern: '/channel/:id', screen: 'channelDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: true, fallbackUrl: 'https://quantube.quant.app/channel' },
      { pattern: '/playlist/:id', screen: 'playlistDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: false, fallbackUrl: 'https://quantube.quant.app/playlist' },
      { pattern: '/studio/:id', screen: 'studioDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: true, fallbackUrl: 'https://quantube.quant.app/studio' },
      { pattern: '/settings/:section', screen: 'settings', params: [{ name: 'section', type: 'string', required: false, defaultValue: 'general' }], requiresAuth: true, fallbackUrl: 'https://quantube.quant.app/settings' },
      { pattern: '/invite/:code', screen: 'invite', params: [{ name: 'code', type: 'string', required: true }], requiresAuth: false, fallbackUrl: 'https://quantube.quant.app/invite' },
      { pattern: '/share/:contentType/:id', screen: 'sharedContent', params: [{ name: 'contentType', type: 'string', required: true }, { name: 'id', type: 'string', required: true }], requiresAuth: false, fallbackUrl: 'https://quantube.quant.app/share' },
    ];
