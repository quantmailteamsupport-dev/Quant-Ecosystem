// Quantube - Widget Service
// Mobile home screen widgets for video platform
...
export class WidgetService {
  ...
  private registerDefaultWidgets(): void {
    const defaults: WidgetDefinition[] = [
      { id: 'trending_videos', name: 'Trending_videos', description: 'Shows trending video thumbnails', sizes: ['small', 'medium'], refreshInterval: '15min', configurable: true, previewImageUrl: '/widgets/trending_videos_preview.png' },
      { id: 'channel_stats', name: 'Channel_stats', description: 'Shows subscriber and view counts', sizes: ['medium', 'large'], refreshInterval: '30min', configurable: true, previewImageUrl: '/widgets/channel_stats_preview.png' },
