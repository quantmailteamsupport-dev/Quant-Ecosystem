// Quantube - Accessibility Service
// Mobile accessibility features for video platform
...
export class AccessibilityService {
  ...
  private registerDefaultVoiceCommands(): void {
    const commands: VoiceCommand[] = [
      { id: 'cmd_play_video', phrase: 'play_video', aliases: ['do play_video'], action: 'play_video', enabled: true },
      { id: 'cmd_subscribe', phrase: 'subscribe', aliases: ['do subscribe'], action: 'subscribe', enabled: true },
      { id: 'cmd_search_videos', phrase: 'search_videos', aliases: ['do search_videos'], action: 'search_videos', enabled: true },
