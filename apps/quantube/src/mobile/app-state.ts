// Quantube - App State Service
// Mobile app state management for video platform
...
export interface AppState {
  ...
  subscriptionsState: Record<string, unknown>;
...
export interface CacheState {
  videoCache: Record<string, unknown>;
  lastCleared: number;
  sizeBytes: number;
  maxSizeBytes: number;
}
...
export class AppStateService {
  ...
  private getDefaultState(): AppState {
    return {
      ...
      cache: { videoCache: {}, lastCleared: Date.now(), sizeBytes: 0, maxSizeBytes: 104857600 },
    };
  }
