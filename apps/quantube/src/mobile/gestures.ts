// Quantube - Gesture Service
// Mobile gesture handling for video platform
...
export class GestureService {
  ...
  private registerDefaultGestures(): void {
    this.registerGesture({ id: 'swipe_left_next_video', type: 'swipe', priority: 10, enabled: true, options: { direction: 'left', action: 'next_video' } });
    this.registerGesture({ id: 'swipe_right_previous_video', type: 'swipe', priority: 10, enabled: true, options: { direction: 'right', action: 'previous_video' } });
    this.registerGesture({ id: 'double_tap_like', type: 'double_tap', priority: 5, enabled: true, options: { action: 'like' } });
    this.registerGesture({ id: 'long_press_add_to_playlist', type: 'long_press', priority: 8, enabled: true, options: { action: 'add_to_playlist' } });
