// Quantsync - Accessibility Service
// Mobile accessibility features for cloud storage platform
...
export class AccessibilityService {
  ...
  private registerDefaultVoiceCommands(): void {
    const commands: VoiceCommand[] = [
      { id: 'cmd_upload_file', phrase: 'upload_file', aliases: ['do upload_file'], action: 'upload_file', enabled: true },
      { id: 'cmd_sync_now', phrase: 'sync_now', aliases: ['do sync_now'], action: 'sync_now', enabled: true },
      { id: 'cmd_view_files', phrase: 'view_files', aliases: ['do view_files'], action: 'view_files', enabled: true },
