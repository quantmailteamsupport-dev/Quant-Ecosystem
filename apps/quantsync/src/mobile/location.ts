// Quantsync - Location Service
// Mobile location services for cloud storage platform
...
export class LocationService {
  ...
  private backgroundConfig: BackgroundLocationConfig = {
    ...
    notificationTitle: 'Quantsync Location',
    notificationBody: 'Using location for location-based backup',
  };
