// Quantsync - Widget Service
// Mobile home screen widgets for cloud storage platform
...
export class WidgetService {
  ...
  private registerDefaultWidgets(): void {
    const defaults: WidgetDefinition[] = [
      { id: 'storage_usage', name: 'Storage_usage', description: 'Shows storage capacity usage', sizes: ['small', 'medium'], refreshInterval: '15min', configurable: true, previewImageUrl: '/widgets/storage_usage_preview.png' },
      { id: 'recent_files', name: 'Recent_files', description: 'Shows recently synced files', sizes: ['medium', 'large'], refreshInterval: '30min', configurable: true, previewImageUrl: '/widgets/recent_files_preview.png' },
