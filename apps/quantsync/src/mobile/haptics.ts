// Quantsync - Haptics Service
// Mobile haptic feedback for cloud storage platform
...
export class HapticsService {
  ...
  private registerDefaultTriggers(): void {
    const triggers: HapticTriggerConfig[] = [
      { action: 'sync_complete', pattern: 'medium', enabled: true },
      { action: 'file_uploaded', pattern: 'success', enabled: true },
      { action: 'folder_shared', pattern: 'light', enabled: true },
