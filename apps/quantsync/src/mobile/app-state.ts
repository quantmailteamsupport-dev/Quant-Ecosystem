// Quantsync - App State Service
// Mobile app state management for cloud storage platform

export interface AppState {
  version: number;
  userId: string | null;
  lastActiveAt: number;
  filesState: Record<string, unknown>;
  syncQueueState: Record<string, unknown>;
...
export class AppStateService {
  ...
  private getDefaultState(): AppState {
    return {
      ...
      cache: { fileCache: {}, lastCleared: Date.now(), sizeBytes: 0, maxSizeBytes: 104857600 },
    };
  }
