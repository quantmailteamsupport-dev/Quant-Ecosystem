// Quantsync - Gesture Service
// Mobile gesture handling for cloud storage platform
...
export class GestureService {
  ...
  private registerDefaultGestures(): void {
    this.registerGesture({ id: 'swipe_left_delete', type: 'swipe', priority: 10, enabled: true, options: { direction: 'left', action: 'delete' } });
    this.registerGesture({ id: 'swipe_right_share', type: 'swipe', priority: 10, enabled: true, options: { direction: 'right', action: 'share' } });
    this.registerGesture({ id: 'double_tap_download', type: 'double_tap', priority: 5, enabled: true, options: { action: 'download' } });
    this.registerGesture({ id: 'long_press_file_info', type: 'long_press', priority: 8, enabled: true, options: { action: 'file_info' } });
