// Quantai - Widget Service
// Mobile home screen widgets for AI/ML platform
...
export class WidgetService {
  ...
  private registerDefaultWidgets(): void {
    const defaults: WidgetDefinition[] = [
      { id: 'training_status', name: 'Training_status', description: 'Shows active training jobs', sizes: ['small', 'medium'], refreshInterval: '15min', configurable: true, previewImageUrl: '/widgets/training_status_preview.png' },
      { id: 'model_metrics', name: 'Model_metrics', description: 'Shows model accuracy scores', sizes: ['medium', 'large'], refreshInterval: '30min', configurable: true, previewImageUrl: '/widgets/model_metrics_preview.png' },
