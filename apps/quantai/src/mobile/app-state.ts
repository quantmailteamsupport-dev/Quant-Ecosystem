// Quantai - App State Service
// Mobile app state management for AI/ML platform

export interface AppState {
  version: number;
  userId: string | null;
  lastActiveAt: number;
  modelsState: Record<string, unknown>;
  experimentsState: Record<string, unknown>;
...
export class AppStateService {
  ...
  private getDefaultState(): AppState {
    return {
      ...
      cache: { resultsCache: {}, lastCleared: Date.now(), sizeBytes: 0, maxSizeBytes: 104857600 },
    };
  }
