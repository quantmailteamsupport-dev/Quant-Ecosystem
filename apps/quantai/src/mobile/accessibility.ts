// Quantai - Accessibility Service
// Mobile accessibility features for AI/ML platform
...
export class AccessibilityService {
  ...
  private registerDefaultVoiceCommands(): void {
    const commands: VoiceCommand[] = [
      { id: 'cmd_start_training', phrase: 'start_training', aliases: ['do start_training'], action: 'start_training', enabled: true },
      { id: 'cmd_view_results', phrase: 'view_results', aliases: ['do view_results'], action: 'view_results', enabled: true },
      { id: 'cmd_deploy_model', phrase: 'deploy_model', aliases: ['do deploy_model'], action: 'deploy_model', enabled: true },
