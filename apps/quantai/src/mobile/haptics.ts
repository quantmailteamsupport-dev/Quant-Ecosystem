// Quantai - Haptics Service
// Mobile haptic feedback for AI/ML platform
...
export class HapticsService {
  ...
  private registerDefaultTriggers(): void {
    const triggers: HapticTriggerConfig[] = [
      { action: 'training_started', pattern: 'medium', enabled: true },
      { action: 'model_deployed', pattern: 'success', enabled: true },
      { action: 'experiment_complete', pattern: 'light', enabled: true },
