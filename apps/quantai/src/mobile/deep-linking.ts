// Quantai - Deep Linking Service
// Mobile deep link handling for AI/ML platform
...
export class DeepLinkService {
  ...
  private universalLinkConfig: UniversalLinkConfig = {
    domain: 'quantai.quant.app',
    appId: 'com.quant.quantai',
    paths: ['/models/*', '/experiments/*', '/datasets/*', '/deployments/*'],
  ...
  private registerDefaultRoutes(): void {
    const defaultRoutes: DeepLinkRoute[] = [
      { pattern: '/models/:id', screen: 'modelsDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: true, fallbackUrl: 'https://quantai.quant.app/models' },
      { pattern: '/experiments/:id', screen: 'experimentsDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: true, fallbackUrl: 'https://quantai.quant.app/experiments' },
      { pattern: '/datasets/:id', screen: 'datasetsDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: false, fallbackUrl: 'https://quantai.quant.app/datasets' },
      { pattern: '/deployments/:id', screen: 'deploymentsDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: true, fallbackUrl: 'https://quantai.quant.app/deployments' },
      { pattern: '/settings/:section', screen: 'settings', params: [{ name: 'section', type: 'string', required: false, defaultValue: 'general' }], requiresAuth: true, fallbackUrl: 'https://quantai.quant.app/settings' },
      { pattern: '/invite/:code', screen: 'invite', params: [{ name: 'code', type: 'string', required: true }], requiresAuth: false, fallbackUrl: 'https://quantai.quant.app/invite' },
      { pattern: '/share/:contentType/:id', screen: 'sharedContent', params: [{ name: 'contentType', type: 'string', required: true }, { name: 'id', type: 'string', required: true }], requiresAuth: false, fallbackUrl: 'https://quantai.quant.app/share' },
    ];
