// Quantai - Offline Sync Service
// Mobile offline synchronization for AI/ML platform
...
export interface ConflictRecord {
  ...
  detectedAt: number;
  resolvedAt?: number;
  resolution?: 'version_merge' | 'manual' | 'discard';
}
...
export class OfflineSyncService {
  ...
  public resolveConflict(conflictId: string, resolution: 'version_merge' | 'manual' | 'discard'): boolean {
