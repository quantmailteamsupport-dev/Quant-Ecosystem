// Quantai - Location Service
// Mobile location services for AI/ML platform
...
export class LocationService {
  ...
  private backgroundConfig: BackgroundLocationConfig = {
    ...
    notificationTitle: 'Quantai Location',
    notificationBody: 'Using location for geo data collection',
  };
