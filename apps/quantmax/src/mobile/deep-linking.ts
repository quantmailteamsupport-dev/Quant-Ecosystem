// Quantmax - Deep Linking Service
// Mobile deep link handling for project management platform
...
export class DeepLinkService {
  ...
  private universalLinkConfig: UniversalLinkConfig = {
    domain: 'quantmax.quant.app',
    appId: 'com.quant.quantmax',
    paths: ['/projects/*', '/tasks/*', '/sprints/*', '/boards/*'],
  ...
  private registerDefaultRoutes(): void {
    const defaultRoutes: DeepLinkRoute[] = [
      { pattern: '/projects/:id', screen: 'projectsDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: true, fallbackUrl: 'https://quantmax.quant.app/projects' },
      { pattern: '/tasks/:id', screen: 'tasksDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: true, fallbackUrl: 'https://quantmax.quant.app/tasks' },
      { pattern: '/sprints/:id', screen: 'sprintsDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: false, fallbackUrl: 'https://quantmax.quant.app/sprints' },
      { pattern: '/boards/:id', screen: 'boardsDetail', params: [{ name: 'id', type: 'string', required: true }], requiresAuth: true, fallbackUrl: 'https://quantmax.quant.app/boards' },
      { pattern: '/settings/:section', screen: 'settings', params: [{ name: 'section', type: 'string', required: false, defaultValue: 'general' }], requiresAuth: true, fallbackUrl: 'https://quantmax.quant.app/settings' },
      { pattern: '/invite/:code', screen: 'invite', params: [{ name: 'code', type: 'string', required: true }], requiresAuth: false, fallbackUrl: 'https://quantmax.quant.app/invite' },
      { pattern: '/share/:contentType/:id', screen: 'sharedContent', params: [{ name: 'contentType', type: 'string', required: true }, { name: 'id', type: 'string', required: true }], requiresAuth: false, fallbackUrl: 'https://quantmax.quant.app/share' },
    ];
