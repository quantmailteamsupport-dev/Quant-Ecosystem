// Quantmax - Accessibility Service
// Mobile accessibility features for project management platform
...
export class AccessibilityService {
  ...
  private registerDefaultVoiceCommands(): void {
    const commands: VoiceCommand[] = [
      { id: 'cmd_create_task', phrase: 'create_task', aliases: ['do create_task'], action: 'create_task', enabled: true },
      { id: 'cmd_view_board', phrase: 'view_board', aliases: ['do view_board'], action: 'view_board', enabled: true },
      { id: 'cmd_mark_complete', phrase: 'mark_complete', aliases: ['do mark_complete'], action: 'mark_complete', enabled: true },
