// Quantmax - Offline Sync Service
// Mobile offline synchronization for project management platform
...
export interface ConflictRecord {
  ...
  detectedAt: number;
  resolvedAt?: number;
  resolution?: 'field_merge' | 'manual' | 'discard';
}
...
export class OfflineSyncService {
  ...
  public resolveConflict(conflictId: string, resolution: 'field_merge' | 'manual' | 'discard'): boolean {
