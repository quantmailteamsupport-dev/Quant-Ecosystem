// Quantmax - Haptics Service
// Mobile haptic feedback for project management platform
...
export class HapticsService {
  ...
  private registerDefaultTriggers(): void {
    const triggers: HapticTriggerConfig[] = [
      { action: 'task_completed', pattern: 'medium', enabled: true },
      { action: 'sprint_closed', pattern: 'success', enabled: true },
      { action: 'milestone_reached', pattern: 'light', enabled: true },
