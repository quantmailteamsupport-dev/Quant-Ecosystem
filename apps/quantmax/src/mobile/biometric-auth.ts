// Quantmax - Biometric Authentication Service
// Mobile biometric authentication for project management platform
...
export class BiometricAuthService {
  ...
  public async authenticate(config?: Partial<BiometricConfig>): Promise<BiometricResult> {
    ...
    const fullConfig: BiometricConfig = {
      ...
      subtitle: 'Authenticate to access project management platform',
  ...
  public async protectSensitiveAction(action: string): Promise<BiometricResult> {
    const sensitiveActions = ['approve_release', 'delete_project', 'delete_account', 'change_password', 'export_data'];
