// Quantedits - Haptics Service
// Mobile haptic feedback for document editing platform
...
export class HapticsService {
  ...
  private registerDefaultTriggers(): void {
    const triggers: HapticTriggerConfig[] = [
      { action: 'document_saved', pattern: 'medium', enabled: true },
      { action: 'comment_resolved', pattern: 'success', enabled: true },
      { action: 'version_published', pattern: 'light', enabled: true },
