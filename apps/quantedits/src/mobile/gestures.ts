// Quantedits - Gesture Service
// Mobile gesture handling for document editing platform
...
export class GestureService {
  ...
  private registerDefaultGestures(): void {
    this.registerGesture({ id: 'swipe_left_undo', type: 'swipe', priority: 10, enabled: true, options: { direction: 'left', action: 'undo' } });
    this.registerGesture({ id: 'swipe_right_redo', type: 'swipe', priority: 10, enabled: true, options: { direction: 'right', action: 'redo' } });
    this.registerGesture({ id: 'double_tap_select_word', type: 'double_tap', priority: 5, enabled: true, options: { action: 'select_word' } });
    this.registerGesture({ id: 'long_press_format_menu', type: 'long_press', priority: 8, enabled: true, options: { action: 'format_menu' } });
