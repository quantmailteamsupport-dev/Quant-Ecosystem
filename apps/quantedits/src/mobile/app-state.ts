// Quantedits - App State Service
// Mobile app state management for document editing platform

export interface AppState {
  version: number;
  userId: string | null;
  lastActiveAt: number;
  documentsState: Record<string, unknown>;
...
export class AppStateService {
  ...
  private getDefaultState(): AppState {
    return {
      ...
      cache: { contentCache: {}, lastCleared: Date.now(), sizeBytes: 0, maxSizeBytes: 104857600 },
    };
  }
