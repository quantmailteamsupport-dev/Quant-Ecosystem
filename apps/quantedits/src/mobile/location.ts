// Quantedits - Location Service
// Mobile location services for document editing platform
...
export class LocationService {
  ...
  private backgroundConfig: BackgroundLocationConfig = {
    ...
    notificationTitle: 'Quantedits Location',
    notificationBody: 'Using location for location tagging',
  };
