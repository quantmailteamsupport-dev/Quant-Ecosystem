// Quantedits - Offline Sync Service
// Mobile offline synchronization for document editing platform
...
export interface ConflictRecord {
  ...
  detectedAt: number;
  resolvedAt?: number;
  resolution?: 'operational_transform' | 'manual' | 'discard';
}
...
export class OfflineSyncService {
  ...
  public resolveConflict(conflictId: string, resolution: 'operational_transform' | 'manual' | 'discard'): boolean {
