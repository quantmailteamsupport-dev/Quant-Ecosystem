// Quantedits - Accessibility Service
// Mobile accessibility features for document editing platform
...
export class AccessibilityService {
  ...
  private registerDefaultVoiceCommands(): void {
    const commands: VoiceCommand[] = [
      { id: 'cmd_save_document', phrase: 'save_document', aliases: ['do save_document'], action: 'save_document', enabled: true },
      { id: 'cmd_add_comment', phrase: 'add_comment', aliases: ['do add_comment'], action: 'add_comment', enabled: true },
      { id: 'cmd_share_document', phrase: 'share_document', aliases: ['do share_document'], action: 'share_document', enabled: true },
