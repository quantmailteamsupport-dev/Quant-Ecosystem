    ...
    <div className="flex h-screen overflow-hidden">
      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center gap-3 border-b border-[var(--quant-border)] px-6">
            ...
            <span className="text-lg font-semibold text-[var(--quant-foreground)]">
              Admin Panel
            </span>
          </div>
          ...
          <div className="border-t border-[var(--quant-border)] p-4">
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[var(--brand-primary)]/10 text-sm font-medium text-[var(--brand-primary)]">
                SA
              </div>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-16 items-center gap-4 border-b border-[var(--quant-border)] bg-[var(--quant-card)] px-6">
          ...
          <span className="text-xs text-[var(--quant-muted-foreground)]">Quant Ecosystem v1.0</span>
        </header>
