// Quantads - Accessibility Service
// Mobile accessibility features for advertising platform
...
export class AccessibilityService {
  ...
  private registerDefaultVoiceCommands(): void {
    const commands: VoiceCommand[] = [
      { id: 'cmd_view_campaigns', phrase: 'view_campaigns', aliases: ['do view_campaigns'], action: 'view_campaigns', enabled: true },
      { id: 'cmd_check_budget', phrase: 'check_budget', aliases: ['do check_budget'], action: 'check_budget', enabled: true },
      { id: 'cmd_create_ad', phrase: 'create_ad', aliases: ['do create_ad'], action: 'create_ad', enabled: true },
