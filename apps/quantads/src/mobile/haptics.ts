// Quantads - Haptics Service
// Mobile haptic feedback for advertising platform
...
export class HapticsService {
  ...
  private registerDefaultTriggers(): void {
    const triggers: HapticTriggerConfig[] = [
      { action: 'campaign_launched', pattern: 'medium', enabled: true },
      { action: 'budget_approved', pattern: 'success', enabled: true },
      { action: 'creative_saved', pattern: 'light', enabled: true },
