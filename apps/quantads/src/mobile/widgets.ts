// Quantads - Widget Service
// Mobile home screen widgets for advertising platform
...
export class WidgetService {
  ...
  private registerDefaultWidgets(): void {
    const defaults: WidgetDefinition[] = [
      { id: 'campaign_performance', name: 'Campaign_performance', description: 'Shows key campaign metrics', sizes: ['small', 'medium'], refreshInterval: '15min', configurable: true, previewImageUrl: '/widgets/campaign_performance_preview.png' },
      { id: 'budget_overview', name: 'Budget_overview', description: 'Shows daily spend vs budget', sizes: ['medium', 'large'], refreshInterval: '30min', configurable: true, previewImageUrl: '/widgets/budget_overview_preview.png' },
