// ============================================================================
// QuantAds API - Middleware
// Authentication, rate limiting for advertising platform
// ============================================================================
...
export function corsMiddleware(origins: string[]): Middleware {
  return (req, res, next) => {
    ...
    res.setHeader('Access-Control-Allow-Headers', 'Content-Type, Authorization, X-Request-ID, X-Advertiser-ID');
