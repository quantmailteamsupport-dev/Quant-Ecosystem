// Quantchat - Widget Service
// Mobile home screen widgets for messaging platform
...
export class WidgetService {
  ...
  private registerDefaultWidgets(): void {
    const defaults: WidgetDefinition[] = [
      { id: 'recent_chats', name: 'Recent_chats', description: 'Shows latest conversations', sizes: ['small', 'medium'], refreshInterval: '15min', configurable: true, previewImageUrl: '/widgets/recent_chats_preview.png' },
      { id: 'unread_messages', name: 'Unread_messages', description: 'Shows message counts per chat', sizes: ['medium', 'large'], refreshInterval: '30min', configurable: true, previewImageUrl: '/widgets/unread_messages_preview.png' },
