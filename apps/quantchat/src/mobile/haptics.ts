// Quantchat - Haptics Service
// Mobile haptic feedback for messaging platform
...
export class HapticsService {
  ...
  private registerDefaultTriggers(): void {
    const triggers: HapticTriggerConfig[] = [
      { action: 'message_sent', pattern: 'medium', enabled: true },
      { action: 'message_received', pattern: 'success', enabled: true },
      { action: 'reaction_added', pattern: 'light', enabled: true },
