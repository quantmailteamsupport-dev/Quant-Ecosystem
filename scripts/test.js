...
const requiredPackages = ['common', 'database', 'auth', 'ai', 'shared-ui', 'realtime', 'server', 'analytics', 'notifications', 'search', 'media', 'payments', 'moderation', 'i18n', 'ecosystem-bridge', 'recommendations', 'data-pipeline', 'developer-platform'];
